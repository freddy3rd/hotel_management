  ...
  <div className="relative z-10 h-full flex flex-col justify-center  px-6 md:px-16 text-white max-w-350 m-auto">
    <div className="relative flex gap-12 place-content-center">
       <div className="relative">
        ...
        <button className="bg-surface text-text-primary font-display h-max font-bold px-8 py-3 my-4 mx-2 tracking-widest text-sm transition-all duration-300 hover:bg-surface-muted hover:scale-105 active:scale-95 uppercase cursor-pointer place-self-center">
            Contact Us
        </button>
